...
<div class="container-fluid pt-4 px-4">
        ...
        <div class="col-sm-12 col-xl-6 offset-3">
            <div class="bg-secondary rounded h-100 p-4">
                ...
                <table class="table">
                    <thead>
                        <tr>                            
                            <th scope="col">Idvoiture</th><th scope="col">Designation</th><th scope="col">Marque</th>
                        </tr>
                    <tbody>
                        <% for(Voiture o:liste){ %>
                            <tr>
                                <td><%= o.getIdvoiture() %></td><td><%= o.getDesignation() %></td><td><%= o.getMarque().getLabel() %></td>
                                <td>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        ...
                                        <form action="/V/updatevoiture.do" method="put">
    ...
    <input type="text" class="form-control" id="designationinput" aria-describedby="designationhelp" name="designation" value="<%= o.getDesignation() %>"> 
</div>
<div class="form-floating mb-3"> 
    ...
    <label for="marqueSelect">
        Marque
                                ...
                                <td><form action="/V/deletevoiture.do" method="delete">
                                    <input type="hidden" name="idvoiture" value="<%= o.getIdvoiture() %>">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
            <form action="/V/insertvoiture.do" method="post">
            <div class="modal-header">
