        ...
        <div class="col-sm-12 col-xl-6 offset-3">
            <div class="bg-secondary rounded h-100 p-4">
                ...
                <table class="table">
                    <thead>
                        <tr>                            
                            <th scope="col">Idmarque</th><th scope="col">Nommarque</th><th scope="col">Datesortie</th>
                        </tr>
                    <tbody>
                        <% for(Marque o:liste){ %>
                            <tr>
                                <td><%= o.getIdmarque() %></td><td><%= o.getNommarque() %></td><td><%= o.getDatesortie() %></td>
                                <td>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        ...
                                        <form action="/V/updatemarque.do" method="put">
...
<div class="mb-3"> 
    <label for="datesortieinput" class="form-label">Datesortie
    </label> 
    <input type="date" class="form-control" id="datesortieinput" aria-describedby="datesortiehelp" name="datesortie" value="<%= o.getDatesortie() %>"> 
</div>
                                ...
                                <td><form action="/V/deletemarque.do" method="delete">
                                    <input type="hidden" name="idmarque" value="<%= o.getIdmarque() %>">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
            <form action="/V/insertmarque.do" method="post">
            <div class="modal-header">
...
<div class="mb-3"> 
    ...
    <input type="date" class="form-control" id="datesortieinput" aria-describedby="datesortiehelp" name="datesortie"> 
</div>
